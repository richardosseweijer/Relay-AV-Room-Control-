...
Relay **0.9.45** (beta). Single-process LAN AV room controller. Phase B software checkpoint (B5). LE/ACME parked; C1–C3 in-box Generate + Networks UI + regenerate lifecycle shipped; C4 Planned.
...
| 15 | HTTP on AV-LAN; venue HTTPS B1 + peer B3 + nicFace B4 (B5 checkpoint); LE parked; Generate C1–C3 shipped; C4 Planned |
