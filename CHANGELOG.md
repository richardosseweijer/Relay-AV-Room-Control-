...
- Docs (I3): cross-ref hygiene (FOYER Day-one §4/§5/§6a; LINUX §6 build-before-units); `ffmpeg` note in §3; uninstall appendix §10; neutral `RELAY_USER=ubuntu` examples. No version bump.
