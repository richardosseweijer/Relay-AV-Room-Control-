...
Relay **0.8.2.8** (beta). Room controller for local AV devices. Private LAN only. Tag `v0.8.2.8` is a snapshot of this tree; install and update from **`main`**. After Update, Configurator → Room shows `0.8.2.8 (<git sha>)`.
