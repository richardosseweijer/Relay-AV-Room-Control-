...
/** NIC-split Phase A (A1–A4) done; B1 = venue HTTPS listen; B3 = peer over venue HTTPS (peer-venue.ts); B4 = per-device nicFace (device-face.ts). B2 = LE/ACME. Device/control defaults to roomLanBind / nicFace=av. listHostInterfaces = serial/GPIO/MIDI, not NICs. */
