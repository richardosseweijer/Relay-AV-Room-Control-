...
/** NIC-split Phase A (A1–A4) done; B1 = venue HTTPS listen; B3 = peer over venue HTTPS (peer-venue.ts). B2 = LE/ACME; B4 = per-device nicFace (not started). Device/control defaults to roomLanBind. listHostInterfaces = serial/GPIO/MIDI, not NICs. */
